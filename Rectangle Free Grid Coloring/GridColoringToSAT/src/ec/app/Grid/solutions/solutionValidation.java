/**
 * This package just contains the parameter files used to determine solutions
 * using the GA approach.
 *
 * CHANGE LINE 150 TO DETERMINE THE INPUT FILE!!!!!!!!!!!!!!!!
 *
...
public class solutionValidation {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            gridSolution = new FileReader("src/ec/app/Grid/solutions/sol.txt");
