/**
 * This class will output a CSV file that contains the the best individual's 
 * fitness from each run for each output file in the directory. It will create 
 * an output file with this data for each parameter file found.
 *
